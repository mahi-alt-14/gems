...
class QueueingDroppedError(GeminiError):
    """
    Exception raised when the stream is dropped due to queueing (bot-flag),
    and no candidates were received. Indicates the session may have been
    flagged by Google's front-end, typically due to missing anti-abuse cookies
    or expired authentication tokens.
    """
